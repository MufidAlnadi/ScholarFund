              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-slate-500 text-sm leading-6">200 $</p>
                  </div>
                </label>
              </div>
              <div className="relative">
                ...
                >
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-slate-500 text-sm leading-6">400 $</p>
                  </div>
                </label>
              </div>
              <div className="relative">
                ...
                >
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-slate-500 text-sm leading-6">600 $</p>
                  </div>
                </label>
              </div>
              <div className="relative">
